...
class Kirki_Modules_Custom_Sections {
	...
	public function include_sections_and_panels() {
		...
		// Sections.
		$folder_path   = get_template_directory().'/lib/vendor/kirki/modules/custom-sections/sections/';
		...
		// Panels.
		$folder_path = get_template_directory().'/lib/vendor/kirki/modules/custom-sections/panels/';
