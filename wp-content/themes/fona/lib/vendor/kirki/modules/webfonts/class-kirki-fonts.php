...
final class Kirki_Fonts {
	...
	public static function get_google_fonts() {
		...
		if ( null === self::$google_fonts || empty( self::$google_fonts ) ) {
			...
			$fonts = include_once wp_normalize_path( get_template_directory().'/lib/vendor/kirki/modules/webfonts/webfonts.php' );
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'fona' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'fona' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'fona' ),
			'200'       => esc_attr__( 'Light 200', 'fona' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'fona' ),
			'300'       => esc_attr__( 'Book 300', 'fona' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'fona' ),
			'400'       => esc_attr__( 'Normal 400', 'fona' ),
			'regular'   => esc_attr__( 'Normal 400', 'fona' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'fona' ),
			'500'       => esc_attr__( 'Medium 500', 'fona' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'fona' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'fona' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'fona' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'fona' ),
			'700'       => esc_attr__( 'Bold 700', 'fona' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'fona' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'fona' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'fona' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'fona' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'fona' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'fona' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'fona' ),
		);
	}
