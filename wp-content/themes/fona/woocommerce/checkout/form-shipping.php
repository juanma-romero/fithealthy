...
<div class="woocommerce-shipping-fields">
    <h3 class="checkout-block-title"><?php _e( 'Shipping details', 'fona' ); ?></h3>
    <?php if (true === WC()->cart->needs_shipping_address()) : ?>
        ...
        <p id="ship-to-different-address">
            ...
            <label for="ship-to-different-address-checkbox"
                   class="checkbox"><?php esc_html_e('Ship to a different address?', 'woocommerce'); ?></label>
        </p>
    ...
    <?php if (apply_filters('woocommerce_enable_order_notes_field', get_option('woocommerce_enable_order_comments', 'yes') === 'yes')) : ?>
        ...
        <?php if (!WC()->cart->needs_shipping() || wc_ship_to_billing_address_only()) : ?>
            ...
            <h3 class="checkout-block-title"><?php esc_html_e('Additional information', 'woocommerce'); ?></h3>
