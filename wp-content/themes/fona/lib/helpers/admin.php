 ...
 * Fake add menu page
 */
if (!function_exists('zoo_add_menu_page')) {
...
/**
 * Fake add sub menu page.
 *
 * @see    https://developer.wordpress.org/reference/functions/add_submenu_page/
 */
if (!function_exists('zoo_add_sub_menu_page'))
{
    function zoo_add_sub_menu_page($parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '')
    {
