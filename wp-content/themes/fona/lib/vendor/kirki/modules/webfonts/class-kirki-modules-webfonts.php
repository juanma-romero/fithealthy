...
class Kirki_Modules_Webfonts {
	...
	protected function __construct() {
		...
		include_once wp_normalize_path( get_template_directory().'/lib/vendor/kirki/modules/webfonts/class-kirki-fonts.php' );
		include_once wp_normalize_path( get_template_directory().'/lib/vendor/kirki/modules/webfonts/class-kirki-fonts-google.php' );
