...
<div class="woocommerce-billing-fields">
    <?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
        ...
        <h3  class="checkout-block-title"><?php esc_html_e( 'Billing &amp; Shipping', 'woocommerce' ); ?></h3>

    <?php else : ?>

        <h3  class="checkout-block-title"><?php esc_html_e('Billing details', 'woocommerce'); ?></h3>
